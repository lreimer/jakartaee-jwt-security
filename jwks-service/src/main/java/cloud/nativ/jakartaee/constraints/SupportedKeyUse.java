...
@Retention(RUNTIME)
@Constraint(validatedBy = SupportedKeyUseValidator.class)
@Documented
public @interface SupportedKeyUse {
    /**
     * The default validation message key.
     *
     * @return the validation message key
     */
    String message() default "{cloud.nativ.javaee.constraints.SupportedKeyUse.message}";
